...
pub const OPS: &[Op] = &[
    ...
    Op {
        ...
        rate: None,
        effect: Effect::Write,
        request_fields: &["text", "regtype", "origin_host", "app"],
    },
    Op {
        name: "clip.set.rich",
        since: 1,
        ...
        rate: None,
        effect: Effect::Write,
        request_fields: &["uti", "blob", "origin_host"],
    },
    Op {
        name: "clip.set.files",
        since: 1,
    ...
    Op {
        ...
        rate: None,
        effect: Effect::Write,
        request_fields: &["clip_id", "plain_only"],
    },
    Op {
        name: "files.list",
        since: 1,
...
pub fn dispatch(
    ...
    match op.name {
        ...
        "clip.get" => crate::ops::clip::get(ctx),
        "clip.set" => crate::ops::clip::set(request, ctx),
        // §9.3 uti_allow: any UTI on the trusted socket, the seven-UTI set on
        // the public endpoint.
        "clip.set.rich" => crate::ops::clip::set_rich(request, endpoint == Endpoint::Public, ctx),
        "clip.set.files" => crate::ops::clip::set_files(request, ctx),
        "clip.restore" => crate::ops::clip::restore(request, ctx),
