...
---------------------------------------------------------------------------
-- The transfer progress HUD retired here (phase 4, job-runner design §9.4):
-- clipboard restores run under the job runner and modules/jobs renders the
-- capsules, so M.progress/progressCancel/progressHide and their canvas,
-- 15s watchdog, and cancel-hover machinery died with their one consumer
-- (clipboard-picker). The stall look survives below in capsuleTheme — the
-- jobs HUD renders it off the sidecar epoch instead of an explicit flag.
---------------------------------------------------------------------------
